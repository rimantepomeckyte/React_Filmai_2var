...
const DetailedMovie = ({selected, closeMovie}) => {
    return (
        <div className="detailed-movie container-fluid">
            <h2 className="row text-white w-25 ml-3 mt-3">{selected.Title}<span className="font-weight-normal text-success"> ({selected.Year})</span>
            </h2>
            <p className="row w-25 d-flex justify-content-start text-success font-weight-bolder ml-3">Imdb
